...
else 
{
	...
	$qwe = "insert into driver_reg (van_no,make,dri_nam,model,mob_no,dri_address,school_nam,school_loc,password,dri_img)
	values ('$van_no','$make','$dri_nam','$model','$mob_no','$dri_address','$school_nam','$school_loc','$password','$upload_path1')";
