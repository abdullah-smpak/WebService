...
//$date = "2019-01-10";
 ...
 $sql = "SELECT students.name,students.token FROM students JOIN std_att ON std_att.std_id = students.std_id WHERE std_att.status = 1 AND std_att.class = '$class' AND std_att.date = '$date'" ;
...
while($row = mysqli_fetch_array($result2))
{
	...
	$msg = array
          (
		'body' 	=> 'Your Kid Is Present Today',
		'title'	=> 'LMS',
