...
else 
{
 ...
 $qwe = "insert into parent_reg (van_route,kid_nam,school_name,school_location,class,address,mother_nam,mother_no,father_nam,father_no,pass,pro_img,van_no,token,lat,lon)
